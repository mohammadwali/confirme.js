...
(function ($, win, doc) {
    ...
    function confirmMe(options) {
        var settings = $.extend(true, $.confirMe.defaults, options);
        ...
        settings.hasCustomButton = (settings.labels.custom && settings.labels.custom.trim() && settings.labels.custom.length);
    ...
    function initialize(set) {
        ...
        confirm_btn.className = "btn btn-md rounded w-xs pull-right confirme-popup-confirm";
        cancel_btn.className = "btn btn-md rounded w-xs pull-left confirme-popup-cancel";
        custom_btn.className = "btn btn-md rounded w-xs pull-left confirme-popup-custom";
